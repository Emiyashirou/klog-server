...
import static com.klog.utils.CommentUtils.getStatusOfHidden;
import static com.klog.utils.CommentUtils.isValidHideComment;
import static org.jooq.impl.DSL.field;
import static org.jooq.impl.DSL.table;

public class HideComment implements RequestHandler<Comment, Object> {

    public Map<String, Object> handleRequest(Comment input, Context context) {

        System.getProperties().setProperty("org.jooq.no-logo", "true");

        if(!isValidHideComment(input)){
            throw new BadRequestException("Invalid hide comment input");
        }
